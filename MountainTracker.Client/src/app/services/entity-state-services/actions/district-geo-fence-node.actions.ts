...
export const mapDistrictGeoFenceNodesSuccess = createAction('[DistrictGeoFenceNode/API] Map DistrictGeoFenceNodes', props<{ entityMap: EntityMap<DistrictGeoFenceNode> }>());
