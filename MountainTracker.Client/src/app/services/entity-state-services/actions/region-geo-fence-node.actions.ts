...
export const mapRegionGeoFenceNodesSuccess = createAction('[RegionGeoFenceNode/API] Map RegionGeoFenceNodes Success', props<{ entityMap: EntityMap<RegionGeoFenceNode> }>());
