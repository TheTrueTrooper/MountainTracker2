...
public interface IRockClimbingRouteService
{
    ...
    public Task<IEnumerable<RockClimbingRoutes>?> GetRockClimbingRoutesByRockClimbingWall(int climbingWallId);

    public Task<ILookup<int, RockClimbingRoutes>> GetRockClimbingRoutesByRockClimbingWalls(IEnumerable<int> climbingWallIds);

    public Task<IDictionary<int, RockClimbingRoutes>> GetRockClimbingRoutesByIds(IEnumerable<int> ids);
