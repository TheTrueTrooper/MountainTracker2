...
public class ProvinceOrStateService_Should
{
    ...
    public async void Get_ProvincesOrStates_Based_On_Code_On_GetProvinceOrStateByCode_Call(string regionCode, short? expectedId)
    {
    ...
    [InlineData(39)]
    [InlineData(235)]
    public async void Get_ProvincesOrStates_Based_On_Id_On_GetProvinceOrStateById_Call(byte id)
    {
        var stableExpectList = new List<ProvincesOrStates>(FullList);
